...
type NotificationType = "pedido" | "pago" | "cliente" | "sistema" | "resena"
...
const mockNotifications: Notification[] = [
  {
    ...
    message: "Tienda Don Juan ha realizado un pedido por $345.00",
    time: "Hace 5 minutos",
    read: false,
    actionUrl: "/proveedor/pedidos/ORD-2024-156"
  },
  {
    id: "2",
    type: "pedido",
    title: "Pedido actualizado",
    message: "El pedido #ORD-2024-155 ha sido marcado como entregado",
    time: "Hace 1 hora",
    read: false,
    actionUrl: "/proveedor/pedidos/ORD-2024-155"
  },
  {
    id: "3",
    type: "cliente",
    title: "Nuevo cliente registrado",
    message: "Minimarket El Sol se ha registrado y puede ver tus productos",
    time: "Hace 3 horas",
    read: false,
  },
  {
    ...
    type: "pago",
    title: "Pago recibido",
    message: "Has recibido un pago de $567.00 por el pedido #ORD-2024-150",
    time: "Hace 5 horas",
    read: true,
    actionUrl: "/proveedor/pagos"
  },
  {
    id: "5",
    type: "resena",
    title: "Nueva reseña",
    message: "Tienda La Esquina ha dejado una reseña de 5 estrellas",
    time: "Ayer",
    read: true,
  },
  {
    ...
    type: "sistema",
    title: "Stock bajo",
    message: "El producto 'Coca-Cola 2L x6' tiene stock bajo (5 unidades)",
    time: "Ayer",
    read: true,
    actionUrl: "/proveedor/productos"
  },
  {
    id: "7",
    type: "pago",
    title: "Transferencia completada",
    message: "Se ha transferido $2,450.00 a tu cuenta bancaria",
    time: "Hace 2 días",
    read: true,
  },
  {
    ...
    message: "Tu cuenta de proveedor ha sido verificada exitosamente",
    time: "Hace 1 semana",
    read: true,
  },
]
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0">
          ...
          {(["all", "pedido", "pago", "cliente", "sistema", "resena"] as const).map((type) => (
            <button
              key={type}
            ...
            >
              {type === "all" ? "Todos" : type === "resena" ? "Reseñas" : type.charAt(0).toUpperCase() + type.slice(1)}
            </button>
          ))}
        </div>
      </div>
